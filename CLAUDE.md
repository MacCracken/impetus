# Impetus — Claude Code Instructions

## Project Identity

**Impetus** (Latin: driving force) — Physics engine — 2D/3D rigid bodies, collision, constraints, spatial hash, particles
...
kiran (game physics), joshua (simulation), aethersafha (window physics)

**Note**: Uses hisab types natively (not glam directly). Deterministic physics (BTreeMap for iteration order). Vec arena storage.
## Development Process
