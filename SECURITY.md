...
If you discover a security vulnerability in impetus, please report it
...
This policy covers the `impetus` crate and its published API. Vulnerabilities
in dependencies should be reported to the respective upstream projects (and
flagged here if they affect impetus users).
